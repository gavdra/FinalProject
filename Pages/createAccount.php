                    ...
                    <div class="mdl-card mdl-shadow--6dp center">
                        ...
                        <form action="../Service/login/loginUtil.php" method="post" autocomplete="off">
                            ...
                            <div class="mdl-card__actions mdl-card--border">
                                <button type="submit" name="createAccountButton" class="mdl-button mdl-js-button mdl-button--raised">Create</button>
                                <button type="button" class="mdl-button mdl-js-button mdl-button right"><a href="../index.php">Login</a></button>
                            </div>
                        </form>
                    </div>
                </div>
